...
| `<service> --endpoint <path> [--method <GET\|POST>] [--query <key=value>...] [--body-json <json>]` | Any endpoint under `airbnb`, `booking`, `google-flights`, `instagram`, `linkedin`, `tiktok`, or `twitter` |
